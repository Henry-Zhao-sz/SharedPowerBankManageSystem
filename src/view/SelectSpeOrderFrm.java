...
public class SelectSpeOrderFrm extends JInternalFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					SelectSpeOrderFrm frame = new SelectSpeOrderFrm();
	 ...
	 * Create the frame.
	 */
	public SelectSpeOrderFrm() {
		setTitle("查询指定用户的订单");
		setClosable(true);
		setIconifiable(true);
		setBounds(100, 100, 611, 418);
		
		JLabel lblNewLabel = new JLabel("请输入要查询的订单编号");
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
                ...
                order order1 = odi.queryByOrderID(orderid);
				if(order1==null) {
					JOptionPane.showMessageDialog(null, "查询失败，无此订单");
				}
				else {
		...
		groupLayout.setHorizontalGroup(
			groupLayout.createParallelGroup(Alignment.LEADING)
				...
				.addGroup(groupLayout.createSequentialGroup()
					...
					.addGap(52)
					.addComponent(orderIDText, GroupLayout.PREFERRED_SIZE, 85, GroupLayout.PREFERRED_SIZE)
			...
			groupLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(groupLayout.createSequentialGroup()
					...
					.addGroup(groupLayout.createParallelGroup(Alignment.BASELINE)
						...
						.addComponent(orderIDText, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
						.addComponent(lblNewLabel))
					.addGap(32)
